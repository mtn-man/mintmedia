...
Set `preserve_episode_titles = true` under `[naming]` to keep an already-clean episode title instead of discarding it (`Show Name - S01E06 - Episode Title.mkv` sorts in as-is). Off by default; see [Configuration](docs/configuration.md#keeping-already-clean-episode-titles).
